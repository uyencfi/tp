...
--------|------------------
**Add** | `add n/NAME p/PHONE_NUMBER e/EMAIL i/INFO [t/TAG]…​` <br> e.g., `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 t/friend t/colleague`
**Clear** | `clear`
