...
import static seedu.edrecord.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, Address.MESSAGE_CONSTRAINTS); // invalid edrecord
